...
function addsource() {
  ...
  $('.video-stu').html('正在载入视频 ...')
  $('.video-stu').fadeTo("1100",0.8)
  var t = GLOBAL_CONFIG.movies.names.split(','),
    _t = t[Math.floor(Math.random() * t.length)]
  $('#bgvideo').attr('src', GLOBAL_CONFIG.movies.url + '/' + _t)
...
function restore_main() {
  ...
  var Info_div=document.getElementById("site-info-div")
